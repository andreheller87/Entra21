...
public class Animal {
	...
	public Animal(String nome, String classe, String familia, Integer idade, Boolean estado, Integer caloria,
			Integer forca) {
		this.nome = nome;
		this.classe = classe;
	...
	public String dormir() {
        ...
        return "O animal está domingo agora! Sua força aumentou para " + forca + " e suas calorias aumentaram para " + caloria;
	}
